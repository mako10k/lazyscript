 ...
 * @return The new application expression.
 */
lsapi_eappl_concat_args const lseappl_t *
lseappl_concat_args(lseappl_t *eappl, size_t argc, const lsexpr_t *args[]);
 ...
 * @param eappl The application expression.
 */
lsapi_print void lseappl_print(FILE *stream, lsprec_t prec, int indent,
