...
const lsealge_t* lsealge_new(const lsstr_t* constr, lssize_t argc, const lsexpr_t* const* args) {
...
const lsealge_t* lsealge_add_arg(const lsealge_t* ealge, const lsexpr_t* arg) {
  ...
  lsealge_t* ealge_new  = lsmalloc(sizeof(lsealge_t) + (argc + 1) * sizeof(lsexpr_t*));
...
const lsealge_t* lsealge_concat_args(const lsealge_t* ealge, lssize_t argc,
  ...
  lsealge_t* ealge_new  = lsmalloc(sizeof(lsealge_t) + (argc0 + argc) * sizeof(lsexpr_t*));
  ealge_new->lea_constr = ealge->lea_constr;
...
const lsstr_t*         lsealge_get_constr(const lsealge_t* ealge) { return ealge->lea_constr; }

lssize_t               lsealge_get_argc(const lsealge_t* ealge) { return ealge->lea_argc; }

const lsexpr_t*        lsealge_get_arg(const lsealge_t* ealge, int i) { return ealge->lea_args[i]; }

const lsexpr_t* const* lsealge_get_args(const lsealge_t* ealge) { return ealge->lea_args; }
