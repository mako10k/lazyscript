 ...
 * @return The new list expression.
 */
lsapi_elist_op1 const lselist_t* lselist_push(const lselist_t* elist, const lsexpr_t* expr);
 ...
 * @return The new list expression.
 */
lsapi_elist_op2 const lselist_t* lselist_pop(const lselist_t* elist, const lsexpr_t** pexpr);
 ...
 * @return The new list expression.
 */
lsapi_elist_op1 const lselist_t* lselist_unshift(const lselist_t* elist, const lsexpr_t* expr);
 ...
 * @return The new list expression.
 */
lsapi_elist_op2 const lselist_t* lselist_shift(const lselist_t* elist, const lsexpr_t** pexpr);
 ...
 */
lsapi_elist_op1 const lselist_t* lselist_concat(const lselist_t* elist1, const lselist_t* elist2);
