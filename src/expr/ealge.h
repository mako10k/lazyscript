 ...
 */
lsapi_ealge_new const lsealge_t* lsealge_new(const lsstr_t* constr, lssize_t argc,
 ...
 */
lsapi_ealge_add_arg const lsealge_t* lsealge_add_arg(const lsealge_t* ealge, const lsexpr_t* arg);
 ...
 */
lsapi_ealge_concat_args const lsealge_t* lsealge_concat_args(const lsealge_t* ealge, lssize_t argc,
                                                             const lsexpr_t* const* args);
 ...
 */
lsapi_print void lsealge_print(FILE* fp, lsprec_t prec, int indent, const lsealge_t* ealge);