...
const lspalge_t* lspalge_new(const lsstr_t* constr, lssize_t argc, const lspat_t* const* args) {
  assert(argc == 0 || args != NULL);
  lspalge_t* palge  = lsmalloc(sizeof(lspalge_t) + argc * sizeof(const lspat_t*));
...
const lspalge_t* lspalge_add_arg(const lspalge_t* palge, const lspat_t* arg) {
  ...
  lspalge_t* new_palge  = lsmalloc(sizeof(lspalge_t) + (argc + 1) * sizeof(const lspat_t*));
...
const lspalge_t* lspalge_concat_args(const lspalge_t* palge, lssize_t argc,
  ...
  lspalge_t* palge0  = lsmalloc(sizeof(lspalge_t) + (argc0 + argc) * sizeof(const lspat_t*));
...
const lsstr_t* lspalge_get_constr(const lspalge_t* palge) { return palge->lpa_constr; }

lssize_t       lspalge_get_arg_count(const lspalge_t* palge) { return palge->lpa_argc; }

const lspat_t* lspalge_get_arg(const lspalge_t* alge, int i) { return alge->lpa_args[i]; }
